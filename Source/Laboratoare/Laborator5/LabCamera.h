	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(1, 0, 0)) * glm::vec4(forward, 1.0);
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1.0);
				forward = glm::normalize(glm::vec3(newVec));

				newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1.0);
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1.0);
				right = glm::normalize(glm::vec3(newVec));
